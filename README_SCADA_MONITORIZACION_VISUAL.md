...
El siguiente diagrama muestra el contexto y la estructura general de contenedores de la solución.

<p align="center">
  <img src="./c4_architecture.svg" alt="Diagrama C4 de arquitectura" width="980">
</p>
...
Diagrama conceptual de despliegue orientado a buenas prácticas de infraestructura moderna.

<p align="center">
  <img src="./system_architecture_cloud.svg" alt="Arquitectura estilo cloud" width="980">
</p>
...
> Aunque el despliegue final puede ser on-premise, el diagrama transmite una arquitectura profesional, desacoplada y mantenible.

---

## 🗄️ Modelo de datos y UML

Esquema conceptual del modelo de base de datos para lecturas, alarmas y entidades de proceso.

<p align="center">
  <img src="./uml_database_schema.svg" alt="UML base de datos" width="980">
</p>
...
- Facilitar historización eficiente
- Mantener trazabilidad por equipo y timestamp
- Permitir explotación por API, SCADA y reporting
- Preparar el crecimiento futuro del sistema
...
- El sistema realiza polling periódico.
- Valida y transforma datos.
- Inserta histórico.
- Expone resultados en interfaz y sistemas externos.
- Si hay interrupción, activa procesos de recuperación de huecos.

---

## 🗂️ Estructura del repositorio GitHub

Repositorio ficticio propuesto para reflejar un proyecto profesional y transferible.
...
├── diagrams/
│   ├── c4_architecture.svg
│   ├── uml_database_schema.svg
│   └── system_architecture_cloud.svg
├── src/
│   ├── acquisition/
│   ├── historian/
│   ├── alarms/
...
- Ordena documentación y operación
- Transmite madurez de proyecto
...
### Parámetros clave
- **database**: conexión a persistencia
- **iec102.polling_interval**: ritmo de lectura
- **historian.retention_days**: política de retención

---

## 📈 Observabilidad

La solución está pensada para integrarse con una capa moderna de monitorización.
...
- Soporte operativo
- Ajustes menores
- Acompañamiento técnico al equipo del cliente
